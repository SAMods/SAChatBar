<?php
	...
	**/
	...
	function chatTest(){
		global $context, $txt, $language, $boarddir, $dirArray, $indexCount;
		
		$doLang = initLang($language);
		require_once($doLang);
		
		list ($themedir) = initTheme();
		...
		doOutput();//If this is not declared nows the time!
	}
	...
	function savemsggc() {
		...
		global $smcFunc, $member_id, $user_settings, $txt, $context, $modSettings;
